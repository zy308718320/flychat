<template>
  <div style="height: 73px;">
    <div class="wrap">
      ...
      <div class="info-wrap">
        <div class="info-pack" :style="{ visibility: isNoChat ? 'hidden' : 'visible' }" @click.stop="handleShowMembers">
      ...
      <div class="members-wrap list-wrap" :class="{ 'members-wrap-hidden': !isShowMembers }" @click.stop="handleHideMemberInfo">
        <div class="members-detail-wrap">
          ...
          <div class="member-wrap" v-for="(member, index) in members" :key="'member' + index">
            <img class="member-avatar" :src="member.avatar" @click.stop="handleShowMemberInfo($event, index)" />
